...
public class Part08OtherOperations {
    ...
    Flux<User> userFluxFromStringFlux(Flux<String> usernameFlux, Flux<String> firstnameFlux,
        ...
        return Flux.zip(usernameFlux, firstnameFlux, lastnameFlux).map(m -> new User(m.getT1(), m.getT2(), m.getT3()));
    }
    ...
    // TODO Return a valid Mono of user for null input and non null input user (hint: Reactive Streams do not accept
    // null values)
